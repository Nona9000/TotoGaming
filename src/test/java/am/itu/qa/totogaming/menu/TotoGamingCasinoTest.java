...
public class TotoGamingCasinoTest extends TotoGamingBaseTest {
	
	@Test
	public void casinoTest() throws InterruptedException {
		...
		casino.clickOnEgtBtn();
		Assert.assertTrue(casino.isCasinoDisplayed());
