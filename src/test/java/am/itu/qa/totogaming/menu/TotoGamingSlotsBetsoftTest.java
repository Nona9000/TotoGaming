...
import am.itu.qa.totogaming.slotsbetsoft.TotoGamingSlotsBetsoftPage;

public class TotoGamingSlotsBetsoftTest extends TotoGamingBaseTest{
	
	

	@Test
	public void slotsBetsoftTest() throws InterruptedException {
		...
		TotoGamingSlotsBetsoftPage slotsBetsoft = new TotoGamingSlotsBetsoftPage(this.driver);
		slotsBetsoft.clickOnBetsoftButton();
		Assert.assertTrue(slotsBetsoft.isBetsoftDisplayed());
