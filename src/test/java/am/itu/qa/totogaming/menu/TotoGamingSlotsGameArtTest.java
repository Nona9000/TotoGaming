...
import am.itu.qa.totogaming.slotsgameart.TotoGamingSlotsGameArtPage;

public class TotoGamingSlotsGameArtTest extends TotoGamingBaseTest{
	
	
	@Test
	public void slotsGameArtTest() throws InterruptedException {
		...
		TotoGamingSlotsGameArtPage slotsGameArt = new TotoGamingSlotsGameArtPage(this.driver);
		slotsGameArt.clickOnGameArtButton();
		Assert.assertTrue(slotsGameArt.isGameArtDisplayed());
	}
}
