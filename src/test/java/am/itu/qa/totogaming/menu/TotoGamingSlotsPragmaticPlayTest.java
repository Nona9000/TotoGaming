...
import am.itu.qa.totogaming.slotspragmaticplay.TotoGamingSlotsPragmaticPlayPage;

public class TotoGamingSlotsPragmaticPlayTest extends TotoGamingBaseTest{
	
	@Test
	public void slotsPragmaticPlayTest() throws InterruptedException {
		...
		TotoGamingSlotsPragmaticPlayPage slotsPragmaticPlay = new TotoGamingSlotsPragmaticPlayPage(this.driver);
		slotsPragmaticPlay.clickOnPragmaticPlayButton();
		Assert.assertTrue(slotsPragmaticPlay.isPragmaticPlayDisplayed());
