...
import am.itu.qa.totogaming.slotsigrosoft.TotoGamingSlotsIgrosoftPage;

public class TotoGamingSlotsIgrosoftTest extends TotoGamingBaseTest{
	
	

	@Test
	public void slotsIgrosoftTest() throws InterruptedException {
		...
		TotoGamingSlotsIgrosoftPage slotsIgrosoft = new TotoGamingSlotsIgrosoftPage(this.driver);
		slotsIgrosoft.clickOnIgrosoftButton();
		Assert.assertTrue(slotsIgrosoft.isIgrosoftDisplayed());
}
}