...
import am.itu.qa.totogaming.slotsplayson.TotoGamingSlotsPlaysonPage;

public class TotoGamingSlotsPlaysonTest extends TotoGamingBaseTest{
	
	@Test
	public void slotsPlaysonTest() throws InterruptedException {
		...
		TotoGamingSlotsPlaysonPage slotsPlayson = new TotoGamingSlotsPlaysonPage(this.driver);
		slotsPlayson.clickOnPlaysonButton();
		Assert.assertTrue(slotsPlayson.isPlaysonDisplayed());
