...
import am.itu.qa.totogaming.slotsplatipus.TotoGamingSlotsPlatipusPage;

public class TotoGamingSlotsPlatipusTest extends TotoGamingBaseTest{

	
	@Test
	public void slotsPlatipusTest() throws InterruptedException {
		...
		TotoGamingSlotsPlatipusPage slotsPlatipus = new TotoGamingSlotsPlatipusPage(this.driver);
		slotsPlatipus.clickOnPlatipusButton();
		Assert.assertTrue(slotsPlatipus.isPlatipusDisplayed());
}
}