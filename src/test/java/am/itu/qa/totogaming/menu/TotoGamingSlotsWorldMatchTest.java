...
import am.itu.qa.totogaming.slotsworldmatch.TotoGamingSlotsWorldMatchPage;

public class TotoGamingSlotsWorldMatchTest extends TotoGamingBaseTest{
	
	@Test
	public void slotsWorldMatchTest() throws InterruptedException {
		...
		TotoGamingSlotsWorldMatchPage slotsWorldMatch = new TotoGamingSlotsWorldMatchPage(this.driver);
		slotsWorldMatch.clickOnWorldMatchButton();
		Assert.assertTrue(slotsWorldMatch.isWorldMatchDisplayed());
