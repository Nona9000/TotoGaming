...
import am.itu.qa.totogaming.slotsbooongo.TotoGamingSlotsBooongoPage;

public class TotoGamingSlotsBooongoTest extends TotoGamingBaseTest{
	
	
	@Test
	public void slotsBooongoTest() throws InterruptedException {
		...
		TotoGamingSlotsBooongoPage slotsBooongo = new TotoGamingSlotsBooongoPage(this.driver);
		slotsBooongo.clickOnBooongoButton();
		Assert.assertTrue(slotsBooongo.isBooongoDisplayed());
}
}