...
import am.itu.qa.totogaming.slotsnetent.TotoGamingSlotsNetentPage;

public class TotoGamingSlotsNetentTest extends TotoGamingBaseTest{
	
	@Test
	public void slotsNetentTest() throws InterruptedException {
		...
		TotoGamingSlotsNetentPage slotsNetent = new TotoGamingSlotsNetentPage(this.driver);
		slotsNetent.clickOnNetentButton();
		Assert.assertTrue(slotsNetent.isNetentDisplayed());
