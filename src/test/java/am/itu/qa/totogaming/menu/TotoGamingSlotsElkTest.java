...
import am.itu.qa.totogaming.slotselk.TotoGamingSlotsElkPage;

public class TotoGamingSlotsElkTest extends TotoGamingBaseTest{
	
	@Test
	public void slotsElkTest() throws InterruptedException {
		...
		TotoGamingSlotsElkPage slotsElk = new TotoGamingSlotsElkPage(this.driver);
		slotsElk.clickOnElkButton();
		Assert.assertTrue(slotsElk.isElkDisplayed());
