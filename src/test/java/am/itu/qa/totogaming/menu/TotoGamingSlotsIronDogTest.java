...
import am.itu.qa.totogaming.slotsirondog.TotoGamingSlotsIronDogPage;

public class TotoGamingSlotsIronDogTest extends TotoGamingBaseTest{
	
	@Test
	public void slotsIronDogTest() throws InterruptedException {
		...
		TotoGamingSlotsIronDogPage slotsIronDog = new TotoGamingSlotsIronDogPage(this.driver);
		slotsIronDog.clickOnIronDogButton();
		Assert.assertTrue(slotsIronDog.isIronDogDisplayed());
