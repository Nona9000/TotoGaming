...
import am.itu.qa.totogaming.slotsgenii.TotoGamingSlotsGeniiPage;

public class TotoGamingSlotsGeniiTest extends TotoGamingBaseTest{
	
	@Test
	public void slotsGeniiTest() throws InterruptedException {
		...
		TotoGamingSlotsGeniiPage slotsGenii = new TotoGamingSlotsGeniiPage(this.driver);
		slotsGenii.clickOnGeniiButton();
		Assert.assertTrue(slotsGenii.isGeniiDisplayed());
