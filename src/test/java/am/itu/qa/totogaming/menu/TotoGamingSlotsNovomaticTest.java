...
import am.itu.qa.totogaming.slotsnovomatic.TotoGamingSlotsNovomaticPage;

public class TotoGamingSlotsNovomaticTest extends TotoGamingBaseTest{
	
	@Test
	public void slotsNovomaticTest() throws InterruptedException {
		...
		TotoGamingSlotsNovomaticPage slotsNovomatic = new TotoGamingSlotsNovomaticPage(this.driver);
		slotsNovomatic.clickOnNovomaticButton();
		Assert.assertTrue(slotsNovomatic.isNovomaticDisplayed());
