...
import am.itu.qa.totogaming.slotsboominggames.TotoGamingSlotsBoomingGamesPage;

public class TotoGamingSlotsBoomingGamesTest extends TotoGamingBaseTest{
	
	
	@Test
	public void slotsBoomingGamesTest() throws InterruptedException {
		...
		TotoGamingSlotsBoomingGamesPage slotsBoomingGames = new TotoGamingSlotsBoomingGamesPage(this.driver);
		slotsBoomingGames.clickOnBoomingGamesButton();
		Assert.assertTrue(slotsBoomingGames.isBoomingGamesDisplayed());
}
}
