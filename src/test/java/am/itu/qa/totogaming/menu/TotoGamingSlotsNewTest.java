...
import am.itu.qa.totogaming.slotsnew.TotoGamingSlotsNewPage;

public class TotoGamingSlotsNewTest extends TotoGamingBaseTest{
	
	@Test
	public void slotsNewTest() throws InterruptedException {
		...
		TotoGamingSlotsNewPage newPage = new TotoGamingSlotsNewPage(this.driver);
		newPage.clickOnNewButton();
		Assert.assertTrue(newPage.isNewDisplayed());
