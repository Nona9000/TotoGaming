...
import am.itu.qa.totogaming.tournamentshistory.TotoGamingTournamentsHistoryPage;

public class TotoGamingTournamentsHistory extends TotoGamingBaseTest{
	
	@Test
	public void tournamentsHistoryTest() throws InterruptedException {
		...
		TotoGamingTournamentsHistoryPage tournamentsHistory = new TotoGamingTournamentsHistoryPage(this.driver);
		tournamentsHistory.clickOnTournamentsHistory();
		Assert.assertTrue(tournamentsHistory.isTournamentsHistoryDisplayed());
}
}